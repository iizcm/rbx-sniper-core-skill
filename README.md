...
cp -r web3/rbx-sniper-core ~/.hermes/skills/web3/rbx-sniper-core/

# Option B: Install directly from this repository's raw SKILL.md URL
<agent-cli> skills install https://raw.githubusercontent.com/iizcm/rbx-sniper-core-skill/main/SKILL.md

# Option C: Clone this entire repo into your skills directory
git clone https://github.com/iizcm/rbx-sniper-core-skill.git ~/.hermes/skills/web3/rbx-sniper-core/
```
...
```text
skill_view(name="web3/rbx-sniper-core")
```
...
```text
Use the rbx sniper core skill to <describe your specific task here>
```
...
```text
Gunakan skill rbx sniper core untuk <deskripsikan tugas spesifik Anda di sini>
```
